...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('files', function (Blueprint $table) {
            ...
            $table->string('source_name')->default('');
            $table->string('source_reference_no')->default('');
            ...
            $table->unique(['source_name', 'source_reference_no', 'date_received'], 'unique_registry_entry');
        });
    }
